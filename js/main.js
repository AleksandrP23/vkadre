...
/* harmony import */ var _components_gallery_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/gallery.js */ "./src/js/components/gallery.js");
...
if (document.querySelector('.resize-slider')) {
  window.addEventListener('DOMContentLoaded', () => {
    ...
    resizableSwiper('(max-width: 960px)', '.success-company-slider', {
      autoplay: {
        delay: 2000
      },
      speed: 2000,
...
if (document.querySelector('.search-slider')) {
  const swiperSearch = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperSearchs, {
    slidesPerView: 3,
    spaceBetween: 20,
    autoplay: {
      delay: 2000
